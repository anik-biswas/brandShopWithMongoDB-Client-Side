       ...
       // console.log(_id);
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`https://server-management-37uu8jgqf-anik-biswas-projects.vercel.app/product/${_id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
            ...
            <div className=" flex justify-between w-full px-4 py-5">
                ...
                <div className="card-actions justify-end">
                    <div className="btn-group btn-group-vertical space-y-4">
                        <Link to={`/productDetails/${_id}`}><button className="btn w-20 bg-slate-200">View</button></Link>
